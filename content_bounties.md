...
- [Motoko Metacalls](https://github.com/darkdrag00nv2/metacalls.mo )
- [Motoko DateTime Library](https://github.com/edjCase/motoko_datetime/)
- [Stable Buffer Updates](https://github.com/canscale/StableBuffer/pull/10)
- [GZip for Motoko](https://github.com/NatLabs/deflate.mo/tree/main)
- [Metacalls Motoko](https://github.com/darkdrag00nv2/metacalls.mo)
- [Async One Shot Flow - Motoko](https://mops.one/maf)
- [ICRC-16 Candy Library - Rust](https://crates.io/crates/ic_candy)
- [File Upload Pattern](https://github.com/cybrowl/upload-file)
...
- [Customer Service Dapp for Candid UI](https://github.com/dfinity/dfn-components/pull/13)
- [Axon Improvements](https://github.com/icdevsorg/axon)
...
- [ICRC-48 Cross Canister Pipelines Motoko](https://github.com/PanIndustrial-Org/icrc48.mo)
- [ICRC-2 Approve and Transfer From Motoko](https://github.com/PanIndustrial-Org/icrc2.mo)
- [ICRC-3 Transaction Logs Motoko](https://github.com/PanIndustrial-Org/icrc3.mo)
- [ICRC-4 Batch Fungible Transactions](https://github.com/PanIndustrial-Org/icrc4.mo)

### EVM
- [EVM Sign - Rust - A no key wallet for EVM based canister wallets](https://github.com/nikolas-con/ic-evm-sign-starter)
- [EVM Transactions](https://github.com/av1ctor/evm-txs.mo)
- [Merkle Patricia Tree Motoko](https://github.com/f0i/merkle-patricia-trie.mo)

### Security
- [Role Based Access](https://github.com/fury02/rbac-motoko)
- [Role Based Access Admin](https://github.com/fury02/rbac-motoko-web-admin)
